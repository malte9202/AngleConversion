...
class AngleConversion:
    ...
    @staticmethod
    def convert_angle(conversion_type: int, angle_to_convert: float) -> float:  # convert angle
    ...
    @staticmethod
    def print_converted_angle():  # print result + information
        print(AngleConversion.converted_angle)
